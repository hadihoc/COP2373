...
# after their purchase. It then repeat until all tickets have been sold. Then display the total number of buyers.

# This get_tickets function promts for user input
...
def DisplayTotalNumberOfBuyers(num_of_buyers):
...
def main():
    ...
    DisplayTotalNumberOfBuyers(num_of_buyers)
